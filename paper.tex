...
The heart of abstraction that EinsteinPy aims to provide is achieved by some set of data structures that are specifically designed to ease with varieties of gravitational physics problems. The most important and central quantity in all of the general relativity is the metric tensor which defines the background geometry of spacetime on which all the dynamics happen. EinsteinPy provides class metric
\subsection{metric}
\subsection{plotting}
\subsection{symbolic}
